...
export function LinearIssueDemo({ className }: LinearIssueDemoProps): JSX.Element {
		...
		() => [
			{
				...
				body: (
					<span>
						<span className="text-indigo-400">@Alpha</span> Can you implement this feature?
					</span>
				),
				timeLabel: "2m ago",
			},
			...
			},
			{
				...
				body: (
					<span>
						<span className="text-indigo-400">@Alpha</span> Please also add a &quot;system&quot; option
			...
			},
			{
				...
				body: (
					<span>
						<span className="text-[#F8F8F9]">Alpha</span> linked{" "}
	...
	return (
		<div
			...
			role="img"
			aria-label="Animated Linear issue showing Alpha responding to a comment">
			<div
				aria-hidden="true"
