...
const faqs: FAQItem[] = [
	{
		question: "What exactly is Alpha?",
		answer: (
			<>
				Alpha is an open-source, AI-powered coding assistant that runs in VS Code. It goes beyond simple
	...
	{
		question: "How does Alpha differ from Copilot, Cursor, or Windsurf?",
		answer: (
			<>
				Alpha is <strong>open-source and fully customizable</strong>, letting you integrate any AI model you
				...
				browser, and handle deeper tasks. And you&apos;re always in control: Alpha is{" "}
	...
	{
		question: "Is Alpha really free?",
		answer: (
			<>
				Yes! Alpha is completely free and open-source. You&apos;ll only pay for the AI model usage if you use
	...
	},
	{
		...
		answer: (
			<>
				Yes. Because Alpha is an extension in your local VS Code, your code never leaves your machine unless
				you connect to an external AI API. Even then, you control exactly what is sent to the AI model. You can
				use tools like .alphaignore to exclude sensitive files, and you can also run Alpha with offline/local
				models for full privacy.
			</>
		),
	},
	{
		question: "Which AI models does Alpha support?",
		answer: (
			<>
				Alpha is fully model-agnostic, giving you the flexibility to work with whatever AI models you prefer.
				...
				connect any other model that follows Alpha&apos;s Model Context Protocol (MCP).
			</>
		),
	},
	{
		question: "Does Alpha support my programming language?",
		answer: (
			<>
				Likely yes! Alpha supports a wide range of languages—Python, Java, C#, JavaScript/TypeScript, Go,
	...
	},
	{
		...
		answer: (
			<>
				Install Alpha from the{" "}
				<a
					href="https://marketplace.visualstudio.com/items?itemName=AlphaInc.alpha"
					target="_blank"
					rel="noopener noreferrer"
					className="text-primary underline-offset-4 hover:underline">
					VS Code Marketplace
				</a>{" "}
				(or GitHub). Add your AI keys (OpenAI, Anthropic, or other) in the extension settings. Open the Alpha
	...
	},
	{
		...
		answer: (
			<>
				Absolutely. Alpha uses efficient strategies (like partial-file analysis, summarization, or
				...
				<Link href="/enterprise" className="text-primary underline-offset-4 hover:underline">
					Learn more about Alpha for enterprise.
				</Link>
			</>
		),
	},
	{
		...
		answer: (
			<>
				Yes. Alpha was built for enterprise environments. You can self-host AI models or use your own trusted
				provider. All file changes and commands go through permission gating, so nothing runs without your
				approval. And because Alpha is fully open-source, it&apos;s auditable—you can review exactly how it
	...
	{
		question: "Can Alpha run commands and tests automatically?",
		answer: (
			<>
				Yes! One of Alpha&apos;s biggest strengths is its ability to execute commands—always optional and
	...
	},
	{
		...
		answer: (
			<>
				Alpha shines for both serious enterprise development and casual &quot;vibe coding.&quot; You can ask
	...
	{
		question: "Can I contribute to Alpha?",
		answer: (
			<>
				Yes, please do! Alpha is open-source on{" "}
				<a
					href="https://github.com/AlphaInc/Alpha"
					target="_blank"
					rel="noopener noreferrer"
					className="text-primary underline-offset-4 hover:underline">
					GitHub
				...
				<div className="mx-auto mb-24 max-w-3xl text-center">
					<motion.div
						...
						<p className="mt-6 text-lg text-muted-foreground max-w-2xl mx-auto">
							Everything you need to know about Alpha and how it can transform your development
							workflow.
						</p>
					</motion.div>
				</div>
