			...
			<div className="container px-4 mx-auto sm:px-6 lg:px-8">
				<div className="text-center mb-16">
					...
					<p className="text-xl text-muted-foreground max-w-xl mx-auto">
						Alpha is designed from the ground up to give you the confidence to do ever more with AI.
					</p>
				</div>
						...
						<div className="rounded-2xl bg-card outline outline-border/50 hover:outline-8 shadow-lg p-8 h-full group transition-all hover:shadow-2xl">
							...
							<div>
								...
								<div className="text-muted-foreground my-4 space-y-1">
									...
									<p>
										Alpha&apos;s Modes keep models focused on a given task and limit their access to
						...
						<div className="rounded-2xl bg-card outline outline-border/50 hover:outline-8 shadow-lg p-8 h-full group transition-all hover:shadow-2xl">
							...
							<div>
								...
								<div className="text-muted-foreground my-4 space-y-1">
									...
									<p>We made Alpha thoughtfully configurable to fit your workflow as best it can.</p>
								</div>
							</div>
						</div>
					</div>
					...
					<div className="relative col-span-4 h-full">
						<div className="rounded-2xl bg-card outline outline-border/50 hover:outline-8 shadow-lg p-8 h-full group transition-all hover:shadow-2xl">
							...
							<div>
								...
								<div className="text-muted-foreground my-4 space-y-1">
									<p>
										The Alpha Extension is{" "}
										<Link target="_blank" href="https://github.com/AlphaInc/Alpha">
											open source
										</Link>{" "}
