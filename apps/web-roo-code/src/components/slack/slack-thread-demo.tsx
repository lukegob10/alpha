...
export function SlackThreadDemo({ className }: SlackThreadDemoProps): JSX.Element {
		...
		() => [
			{
				...
				kind: "human",
				body: (
					<span>We need to add a page to our Marketing site that highlights using Alpha from Slack.</span>
				),
			},
			{
				id: "m2",
				...
				body: (
					<div className="space-y-2">
						<div>
							The documentation for using Alpha from Slack is here:{" "}
			...
			},
			{
				...
				body: (
					<div className="space-y-3">
						<p>
							I&apos;ve created a comprehensive implementation plan for the Alpha Slack integration
							marketing page at{" "}
							<code className="rounded bg-white/10 px-1.5 py-0.5 text-[12px] text-[#F8F8F9]">
			...
			},
			{
				...
				body: (
					<div className="space-y-3">
						<p>
							I&apos;ve built the Alpha Slack integration marketing page. Here&apos;s what was
							implemented:
						</p>
						...
						<div className="rounded-lg border border-white/10 bg-black/20 px-3 py-2">
							...
							<div className="mt-2">
								...
								<FakeLink className="hover:text-violet-200">
									https://github.com/AlphaInc/Alpha/pull/10853
								</FakeLink>
							</div>
						</div>
	...
	return (
		<div
			...
			role="img"
			aria-label="Animated Slack thread showing Alpha responding as @Roomote">
			<div
				aria-hidden="true"
