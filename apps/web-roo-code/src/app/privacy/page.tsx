...
const DESCRIPTION =
	"Privacy policy for Alpha Cloud and marketing website. Learn how we handle your data and protect your privacy."
			...
			<div className="container mx-auto px-4 py-12 sm:px-6 lg:px-8">
				<div className="prose prose-lg mx-auto max-w-4xl dark:prose-invert">
					<h1 className="text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl">
						Alpha Cloud Privacy Policy
					</h1>
					<p className="text-muted-foreground">Last Updated: September 19, 2025</p>

					<p className="lead">
						This Privacy Policy explains how Alpha, Inc. (&quot;Alpha,&quot; &quot;we,&quot;
					...
					<ul className="lead">
						...
						<li>
							create an account for, sign in to, or otherwise use <strong>Alpha Cloud</strong> at{" "}
							<strong>app.roocode.com</strong> or through the Alpha extension while authenticated to
					...
					<div className="my-8 rounded-lg border border-border bg-muted/50 p-6">
						...
						<p className="mb-0">
							If you run the Alpha extension <strong>without</strong> connecting to a Cloud account,
							your data is governed by the standalone{" "}
							<a
								href="https://github.com/RooCodeInc/Alpha/blob/main/PRIVACY.md"
								target="_blank"
								rel="noopener noreferrer"
								className="text-primary hover:underline">
								Alpha Extension Privacy Policy
							</a>
							.
						</p>
					</div>
					...
					<ul>
						<li>
							<strong>
								Your source code does not transit Alpha servers unless you explicitly choose Alpha
								as a model provider (proxy mode).
							</strong>{" "}
							When Alpha Cloud is your model provider, your code briefly transits Alpha servers only
							...
							TLS—to the model you select. Alpha never stores, inspects, or trains on your code.
						</li>
						<li>
							<strong>Prompts and chat snippets are collected by default</strong> in Alpha Cloud so you
							can search and re‑use past conversations. Organization admins can disable this collection at
							any time.
						</li>
						<li>
							We collect only the data needed to operate Alpha Cloud, do <strong>not</strong> sell
					...
					<ul>
						<li>
							<strong>Operate & secure Alpha Cloud</strong> (authentication, completions, abuse
							prevention)
						</li>
						<li>
						...
						<table className="min-w-full border-collapse border border-border">
							...
							<tbody>
								<tr>
									...
									<td className="border border-border px-4 py-2">
										Your chosen model provider (direct client → provider TLS), or Alpha (proxy
										mode; transit‑only) when you select Alpha as the provider
									</td>
									<td className="border border-border px-4 py-2">
										Alpha servers (except proxy mode; transit‑only, no storage); ad networks;
								...
								<tr>
									...
									<td className="border border-border px-4 py-2">
										Alpha servers (we store only the Stripe customer ID)
									</td>
								</tr>
							</tbody>
						</table>
					...
					<ul>
						<li>
							<strong>Source Code:</strong> Never stored on Alpha servers.
						</li>
						<li>
					...
					<ul>
						...
						<li>
							...
							<strong>Security Settings</strong> inside Alpha Cloud (User Menu &rarr; My Settings
							&rarr; Open Profile).
						</li>
						<li>
