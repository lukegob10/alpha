...
const TITLE = "Alpha Cloud Team Plan"
const DESCRIPTION =
...
const keyBenefits = [
	...
	},
	{
		...
		description:
			"Single billing point for all team members using Cloud Agents and the Alpha Router. No more API key management.",
		icon: DollarSign,
	},
	{
...
const features: Feature[] = [
	...
	},
	{
		...
		description: "Control access to the Alpha MCP Marketplace and what custom MCPs to make available to your team.",
	},
]
			...
			<section className="relative flex pt-32 pb-20 items-center overflow-hidden">
				...
				<div className="container relative flex flex-col items-center h-full z-10 mx-auto px-4 sm:px-6 lg:px-8">
					<div className="text-center max-w-4xl mx-auto mb-12">
						<h1 className="text-4xl font-bold tracking-tight mb-6 md:text-6xl">Alpha Cloud Team</h1>
			...
			<section className="relative overflow-hidden border-t border-border py-32">
				<div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
					...
					<div className="mx-auto mb-12 md:mb-24 max-w-5xl text-center">
						<div>
							<h2 className="text-4xl font-bold tracking-tight mb-4">Why Teams Choose Alpha</h2>
