...
const features: Feature[] = [
	...
	},
	{
		...
		description: "Bring your own keys or use the Alpha Router with access to all top models with no markup.",
	},
	{
		icon: Github,
	...
	},
	{
		...
		description: "Assign issues to Alpha directly from Linear. Get PRs back without switching tools.",
	},
	{
		icon: Users,
