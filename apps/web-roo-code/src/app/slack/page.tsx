...
const ONBOARDING_STEPS: OnboardingStep[] = [
	...
	},
	{
		icon: Settings,
		title: "2. Connect",
		description: 'Sign in to Alpha Cloud and go to Settings. Click "Connect" next to Slack.',
	},
	{
		icon: Slack,
		title: "3. Authorize",
		description: "Authorize the Alpha app to access your Slack workspace.",
	},
	{
		icon: MessageSquare,
				...
				<div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
					...
					<div className="text-center mb-16">
						<h2 className="text-3xl font-bold tracking-tight sm:text-4xl mb-4">
							Why your team will love using Alpha in&nbsp;Slack
						</h2>
						...
						<div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-10 items-center">
							...
							<div className="lg:col-span-3 overflow-hidden rounded-2xl border border-border bg-background shadow-lg">
								<iframe
									...
									title="Alpha Slack Integration Demo"
