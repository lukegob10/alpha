...
export const alphaCodeCloudModelSchema = z.object({
...
export type AlphaCodeCloudModel = z.infer<typeof alphaCodeCloudModelSchema>

export const getAlphaCodeCloudModels = async (): Promise<AlphaCodeCloudModel[]> => {
	...
	const result = z
		.object({
			...
			data: z.array(alphaCodeCloudModelSchema),
		})
...
export const useAlphaCodeCloudModels = () => {
	const query = useQuery({
		queryKey: ["getAlphaCodeCloudModels"],
		queryFn: getAlphaCodeCloudModels,
	})
