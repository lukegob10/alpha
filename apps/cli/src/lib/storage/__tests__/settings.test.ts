...
const { getTestConfigDir } = vi.hoisted(() => {
	...
	const testConfigDir = path.join(os.tmpdir(), `alpha-cli-settings-test-${testRunId}`)
...
describe("Settings Storage", () => {
	...
	describe("loadSettings", () => {
		...
		it("should load saved settings", async () => {
			const settingsData = {
				onboardingProviderChoice: OnboardingProviderChoice.Alpha,
				mode: "architect",
	...
	describe("resetOnboarding", () => {
		it("should reset onboarding provider choice", async () => {
			await saveSettings({ onboardingProviderChoice: OnboardingProviderChoice.Alpha })
