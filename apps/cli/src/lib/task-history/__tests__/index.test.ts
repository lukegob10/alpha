import { readTaskSessionsFromStoragePath } from "@alpha-code/core/cli"
...
vi.mock("@alpha-code/core/cli", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@alpha-code/core/cli")>()
	return {
		...actual,
