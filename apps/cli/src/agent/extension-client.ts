...
import type { ExtensionMessage, WebviewMessage, ClineAskResponse, ClineMessage, ClineAsk } from "@alpha-code/types"
...
/**
 * ExtensionClient is the main interface for interacting with the Alpha extension.
 *
 * Basic usage:
 * ```typescript
