 ...
 *
 * Users can override this with the ALPHA_NERD_FONT environment variable:
 * - ALPHA_NERD_FONT=0 to force ASCII fallbacks (if icons don't render correctly)
 * - ALPHA_NERD_FONT=1 to force Nerd Font icons
 *
...
function detectNerdFontSupport(): boolean {
	...
	const envOverride = process.env.ALPHA_NERD_FONT
	...
	// and users can set ALPHA_NERD_FONT=0 if needed
	return true
}
