/**
 * Theme configuration for Alpha CLI TUI
...
export const alphaHeader = hardcore.yellow // Yellow for Alpha
...
export const alphaText = hardcore.text // Standard text for Alpha
