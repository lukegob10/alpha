...
const RELEASES_URL = "https://api.github.com/repos/RooCodeInc/Alpha/releases?per_page=100"
export const INSTALL_SCRIPT_COMMAND =
	"curl -fsSL https://raw.githubusercontent.com/RooCodeInc/Alpha/main/apps/cli/install.sh | sh"
