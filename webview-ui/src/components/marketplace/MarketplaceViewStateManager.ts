 ...
 *
 * This class manages the state for the marketplace view in the Alpha extensions interface.
 *
 * IMPORTANT: Fixed issue where the marketplace feature was causing the Alpha extensions interface
...
import { MarketplaceItem, MarketplaceInstalledMetadata } from "@alpha-code/types"
...
export class MarketplaceViewStateManager {
	...
	public async handleMessage(message: any): Promise<void> {
		...
		if (message.type === "state") {
			...
			// The state.marketplaceItems come from AlphaProvider, see the file src/core/webview/AlphaProvider.ts
