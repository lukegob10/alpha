	...
	useAppTranslation: () => ({
		t: (key: string) => {
			const translations: Record<string, string> = {
				...
				"cloud:signIn": "Connect to Alpha Cloud",
				"cloud:cloudBenefitsTitle": "Try Alpha Cloud",
				"cloud:cloudBenefitProvider": "Access free and paid models that work great with Alpha",
				...
				"cloud:visitCloudWebsite": "Visit Alpha Cloud",
				"cloud:taskSync": "Task sync",
				"cloud:taskSyncDescription": "Sync your tasks for viewing and sharing on Alpha Cloud",
				...
				"cloud:cloudUrlPillLabel": "Alpha Cloud URL: ",
			}
...
describe("CloudView", () => {
	it("should display benefits when user is not authenticated", () => {
		...
		expect(screen.getByRole("heading", { name: "Try Alpha Cloud" })).toBeInTheDocument()
		expect(screen.getByText("Access free and paid models that work great with Alpha")).toBeInTheDocument()
	...
	it("should not display benefits when user is authenticated", () => {
		...
		expect(screen.queryByText("Access free and paid models that work great with Alpha")).not.toBeInTheDocument()
	...
	it("should not display cloud URL pill when pointing to production", () => {
		...
		expect(screen.queryByText(/Alpha Cloud URL:/)).not.toBeInTheDocument()
	})
	...
	it("should display cloud URL pill when pointing to non-production environment", () => {
		...
		expect(screen.getByText(/Alpha Cloud URL:/)).toBeInTheDocument()
