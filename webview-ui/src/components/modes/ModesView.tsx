...
import { ModeConfig, GroupEntry, PromptComponent, ToolGroup, modeConfigSchema } from "@alpha-code/types"
...
import { TOOL_GROUPS } from "@alpha/tools"
								...
								span: (
									<span
										...
										onClick={() => {
											...
											vscode.postMessage({
												type: "openFile",
												text: `./.alpha/rules-${currentMode.slug}/rules.md`,
												values: {
													create: true,
													content: "",
												},
