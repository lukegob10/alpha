...
import { openAiCodexDefaultModelId } from "@alpha-code/types"
...
vi.mock("@vscode/webview-ui-toolkit/react", () => ({
	...
	VSCodeTextArea: ({ value, onInput }: any) => <textarea value={value} onChange={onInput} />,
...
// Mock Alpha provider for tests
vi.mock("../providers/Alpha", () => ({
	Alpha: ({ cloudIsAuthenticated }: any) => (
