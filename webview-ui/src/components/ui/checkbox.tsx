...
const checkboxVariants = cva(
	"peer h-4 w-4 shrink-0 rounded-[5px] border transition-[background-color,border-color,box-shadow] duration-150 ring-offset-background focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-vscode-focusBorder focus-visible:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50",
	{
		variants: {
			variant: {
				default:
