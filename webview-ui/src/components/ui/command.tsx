...
>(({ className, ...props }, ref) => (
	...
	<div className="flex items-center border-b border-vscode-dropdown-border px-3" cmdk-input-wrapper="">
		...
		<CommandPrimitive.Input
			ref={ref}
			className={cn(
				"flex h-11 w-full rounded-lg bg-transparent py-3 text-base outline-none placeholder:text-muted-foreground disabled:cursor-not-allowed disabled:opacity-50",
				className,
			)}
			{...props}
		/>
...
>(({ className, ...props }, ref) => (
	<CommandPrimitive.Item
		...
		className={cn(
			...
			"data-[selected=true]:bg-[var(--alpha-accent-soft)] data-[selected=true]:text-vscode-foreground",
