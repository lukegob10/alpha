/**
 * Validates the generated schemas/alphamodes.json against sample configurations
 * using AJV. The schema itself is dynamically generated from the Zod types in
 * packages/types/src/mode.ts -- see packages/types/scripts/generate-alphamodes-schema.ts.
 *
 * A separate drift-detection test (alphamodes-schema-sync.spec.ts) ensures the
...
describe("alphamodes JSON schema", () => {
	...
	it("should accept a minimal valid .alphamodes config", () => {
		const config = {
			customModes: [
				{
					slug: "my-mode",
