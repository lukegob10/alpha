...
export const openAiNativeModels = {
	...
	// GPT-5.6 family models. Pricing is intentionally omitted until the
	// provider publishes model-specific rates; capability defaults mirror the
	// current GPT-5.4 Responses API configuration.
	"gpt-5.6-luna": {
		maxTokens: 128000,
		contextWindow: 1_050_000,
		includedTools: ["apply_patch"],
		...
		supportsVerbosity: true,
		supportsTemperature: false,
		description: "GPT-5.6 Luna: OpenAI reasoning model for coding and agentic workflows",
	},
	"gpt-5.6-sol": {
		maxTokens: 128000,
		contextWindow: 1_050_000,
		...
		supportsVerbosity: true,
		supportsTemperature: false,
		description: "GPT-5.6 Sol: OpenAI reasoning model for coding and agentic workflows",
	},
	"gpt-5.6-terra": {
		maxTokens: 128000,
		contextWindow: 1_050_000,
		...
		supportsVerbosity: true,
		supportsTemperature: false,
		description: "GPT-5.6 Terra: OpenAI reasoning model for coding and agentic workflows",
	},
	"gpt-5.4-mini": {
		maxTokens: 128000,
		contextWindow: 400000,
