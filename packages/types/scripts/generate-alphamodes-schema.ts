/**
 * Generates the JSON Schema for .alphamodes configuration files from the Zod
 ...
 *
 * The output is written to schemas/alphamodes.json at the repository root.
 */
...
const outPath = path.join(repoRoot, "schemas", "alphamodes.json")
