...
- **Environment Setup**: Launches VS Code with Alpha extension in isolated container
...
- **Development Tools**: VS Code with language-specific extensions and Alpha extension
