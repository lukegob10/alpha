...
```sh
git clone https://github.com/RooCodeInc/Alpha.git
cd Alpha
```
...
By default an evals run will run all programming exercises in [Alpha Evals](https://github.com/RooCodeInc/Alpha-Evals) repository with the Claude Sonnet 4 model and default settings. For basic configuration you can specify the LLM to use and any subset of the exercises you'd like. For advanced configuration you can import a Alpha settings file which will allow you to run the evals with Alpha configured any way you'd like (this includes custom modes, custom instructions, etc).
...
- Optionally builds and installs the Alpha extension from source
