...
if [[ "$(uname -s)" != "Darwin" ]]; then
  ...
  echo "See https://github.com/RooCodeInc/Alpha/blob/main/packages/evals/README.md for instructions."
  exit 1
fi
...
if [[ ! -d "../../../evals" ]]; then
  ...
  git clone https://github.com/RooCodeInc/Alpha-Evals.git ../../../evals || exit 1
  echo "✅ Done"
else
