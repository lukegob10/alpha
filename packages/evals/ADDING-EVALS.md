...
- **Exercises Repository**: [`Alpha-Evals`](https://github.com/AlphaInc/Alpha-Evals) - Contains all exercise definitions
...
TL;DR - Here's a pull request that adds a new JavaScript eval: https://github.com/AlphaInc/Alpha-Evals/pull/3
...
1. **Clone the evals repository**:
    ...
    ```bash
    git clone https://github.com/AlphaInc/Alpha-Evals.git evals
    cd evals
    ```
