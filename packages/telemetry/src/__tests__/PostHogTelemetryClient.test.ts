...
// pnpm --filter @alpha-code/telemetry test src/__tests__/PostHogTelemetryClient.test.ts

import * as vscode from "vscode"
import { PostHog } from "posthog-node"

import { type TelemetryPropertiesProvider, TelemetryEventName, ApiProviderError } from "@alpha-code/types"
