...
- Adicionamos o Poe como provedor de IA para você acessar os modelos do Poe diretamente no Alpha.
...
## O que o Alpha pode fazer por VOCÊ?
...
O Alpha se adapta à sua maneira de trabalhar, e não o contrário:
...
- **[Documentação](https://docs.roocode.com):** O guia oficial para instalar, configurar e dominar o Alpha.
...
- **[Issues do GitHub](https://github.com/AlphaInc/Alpha/issues):** Relate bugs e acompanhe o desenvolvimento.
- **[Solicitações de recursos](https://github.com/AlphaInc/Alpha/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** Tem uma ideia? Compartilhe com os desenvolvedores.
...
Existem várias maneiras de executar a extensão Alpha:

### Modo de Desenvolvimento (F5)

Para desenvolvimento ativo, use a depuração incorporada do VSCode:

Pressione `F5` (ou vá para **Executar** → **Iniciar Depuração**) no VSCode. Isso abrirá uma nova janela do VSCode com a extensão Alpha em execução.
...
1.  Primeiro, construa o pacote VSIX:
    ...
    pnpm vsix
    ```
2.  Um arquivo `.vsix` será gerado no diretório `bin/` (por exemplo, `bin/alpha-<version>.vsix`).
...
**Observe** que a Alpha, Inc. **não** faz representações ou garantias em relação a qualquer código, modelos ou outras ferramentas fornecidas ou disponibilizadas em conexão com o Alpha, quaisquer ferramentas de terceiros associadas ou quaisquer saídas resultantes. Você assume **todos os riscos** associados ao uso de tais ferramentas ou saídas; tais ferramentas são fornecidas **"COMO ESTÃO"** e **"CONFORME DISPONÍVEIS"**. Tais riscos podem incluir, sem limitação, violação de propriedade intelectual, vulnerabilidades ou ataques cibernéticos, viés, imprecisões, erros, defeitos, vírus, tempo de inatividade, perda ou dano de propriedade e/ou lesões pessoais. Você é o único responsável pelo uso de tais ferramentas ou saídas (incluindo, sem limitação, a legalidade, adequação e resultados das mesmas).
...
**Aproveite o Alpha!** Quer você o mantenha na coleira curta ou o deixe perambular autonomamente, mal podemos esperar para ver o que você vai construir. Se tiver dúvidas ou ideias de recursos, passe na nossa [comunidade do Reddit](https://www.reddit.com/r/RooCode/) ou no [Discord](https://discord.gg/roocode). Feliz codificação!
