...
- **Verifique as issues existentes**: Pesquise nas [Issues do GitHub](https://github.com/RooCodeInc/Alpha/issues).
...
- Para documentação, visite [Documentação do Alpha](https://github.com/RooCodeInc/Alpha-Docs).

### Relatando bugs

- Verifique primeiro os relatórios existentes.
- Crie um novo bug usando o [modelo "Relatório de bug"](https://github.com/RooCodeInc/Alpha/issues/new/choose) com:
    - Passos de reprodução claros e numerados
    - Resultado esperado vs. real
    - Versão do Alpha (obrigatório); provedor/modelo de IA, se relevante
- **Problemas de segurança**: Relate em particular através de [avisos de segurança](https://github.com/RooCodeInc/Alpha/security/advisories/new).
...
```
git clone https://github.com/SEU_NOME_DE_USUARIO/Alpha.git
```
...
Ao contribuir, você concorda que suas contribuições serão licenciadas sob a Licença Apache 2.0, consistente com o licenciamento do Alpha.
