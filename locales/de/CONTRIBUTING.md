...
### 3. Tritt der Alpha Community bei
...
- **Überprüfe bestehende Issues**: Suche in den [GitHub Issues](https://github.com/RooCodeInc/Alpha/issues).
...
- Für Dokumentation besuche [Alpha Docs](https://github.com/RooCodeInc/Alpha-Docs).

### Fehler melden

- Überprüfe zuerst, ob bereits Berichte vorhanden sind.
- Erstelle einen neuen Fehler mit der [Vorlage „Fehlerbericht“](https://github.com/RooCodeInc/Alpha/issues/new/choose) mit:
    - Klaren, nummerierten Reproduktionsschritten
    - Erwartetes vs. tatsächliches Ergebnis
    - Alpha-Version (erforderlich); API-Anbieter/Modell, falls relevant
- **Sicherheitsprobleme**: Melde sie privat über [Sicherheitshinweise](https://github.com/RooCodeInc/Alpha/security/advisories/new).
...
```
git clone https://github.com/DEIN_BENUTZERNAME/Alpha.git
```
...
Indem du einen Beitrag leistest, stimmst du zu, dass deine Beiträge unter der Apache-2.0-Lizenz lizenziert werden, die mit der Lizenzierung von Alpha übereinstimmt.
