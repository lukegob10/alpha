...
- Poe als KI-Anbieter hinzugefügt, damit du direkt in Alpha auf Poe-Modelle zugreifen kannst.
...
Alpha passt sich an deine Arbeitsweise an, nicht umgekehrt:
...
- **[Dokumentation](https://docs.roocode.com):** Die offizielle Anleitung zur Installation, Konfiguration und Beherrschung von Alpha.
...
- **[GitHub Issues](https://github.com/AlphaInc/Alpha/issues):** Melde Fehler und verfolge die Entwicklung.
- **[Feature-Anfragen](https://github.com/AlphaInc/Alpha/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** Hast du eine Idee? Teile sie mit den Entwicklern.
...
Es gibt mehrere Möglichkeiten, die Alpha-Erweiterung auszuführen:

### Entwicklungsmodus (F5)

Für die aktive Entwicklung verwende das integrierte Debugging von VSCode:

Drücke `F5` (oder gehe zu **Ausführen** → **Debuggen starten**) in VSCode. Dies öffnet ein neues VSCode-Fenster mit der laufenden Alpha-Erweiterung.
...
1.  Erstelle zuerst das VSIX-Paket:
    ...
    pnpm vsix
    ```
2.  Eine `.vsix`-Datei wird im `bin/`-Verzeichnis generiert (z. B. `bin/alpha-<version>.vsix`).
