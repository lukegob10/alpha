...
# Alpha'a Katkıda Bulunma

Alpha topluluk tarafından yürütülen bir projedir ve her katkıyı derinden takdir ediyoruz. İşbirliğini kolaylaştırmak için [Önce Sorun Yaklaşımı](#önce-sorun-yaklaşımı) temelinde çalışıyoruz, bu da tüm [Çekme İsteklerinin (PR'ler)](#bir-çekme-isteği-gönderme) önce bir GitHub Sorununa bağlanması gerektiği anlamına gelir. Lütfen bu kılavuzu dikkatlice inceleyin.
...
- **Mevcut sorunları kontrol edin**: [GitHub Sorunları](https://github.com/RooCodeInc/Alpha/issues)nda arama yapın.
- **Bir sorun oluşturun**:
...
- Belgeler için [Alpha Belgeleri](https://github.com/RooCodeInc/Alpha-Docs)ni ziyaret edin.

### Hataları Bildirme

- Önce mevcut raporları kontrol edin.
- Aşağıdakilerle ["Hata Raporu" şablonunu](https://github.com/RooCodeInc/Alpha/issues/new/choose) kullanarak yeni bir hata oluşturun:
    - Açık, numaralandırılmış yeniden oluşturma adımları
    - Beklenen vs gerçek sonuç
    - Alpha sürümü (gerekli); ilgiliyse API sağlayıcısı/modeli
- **Güvenlik sorunları**: [Güvenlik tavsiyeleri](https://github.com/RooCodeInc/Alpha/security/advisories/new) aracılığıyla özel olarak bildirin.
...
```
git clone https://github.com/KULLANICI_ADINIZ/Alpha.git
```
...
Katkıda bulunarak, katkılarınızın Alpha'un lisanslamasıyla tutarlı olan Apache 2.0 Lisansı altında lisanslanacağını kabul etmiş olursunuz.
