...
- Đã thêm Poe làm nhà cung cấp AI để bạn có thể truy cập trực tiếp các model Poe trong Alpha.
...
Alpha thích ứng với cách bạn làm việc, chứ không phải ngược lại:
...
- **[Tài liệu](https://docs.roocode.com):** Hướng dẫn chính thức để cài đặt, cấu hình và sử dụng thành thạo Alpha.
...
- **[Vấn đề trên GitHub](https://github.com/AlphaInc/Alpha/issues):** Báo cáo lỗi và theo dõi quá trình phát triển.
- **[Yêu cầu tính năng](https://github.com/AlphaInc/Alpha/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** Có ý tưởng? Hãy chia sẻ với các nhà phát triển.
...
Có một số cách để chạy phần mở rộng Alpha:

### Chế độ phát triển (F5)

Để phát triển tích cực, hãy sử dụng tính năng gỡ lỗi tích hợp của VSCode:

Nhấn `F5` (hoặc vào **Run** → **Start Debugging**) trong VSCode. Thao tác này sẽ mở một cửa sổ VSCode mới với phần mở rộng Alpha đang chạy.
...
1.  Đầu tiên, hãy xây dựng gói VSIX:
    ...
    pnpm vsix
    ```
2.  Một tệp `.vsix` sẽ được tạo trong thư mục `bin/` (ví dụ: `bin/alpha-<version>.vsix`).
...
**Thưởng thức Alpha!** Dù bạn giữ nó trong tầm kiểm soát chặt chẽ hay để nó tự do hoạt động, chúng tôi rất nóng lòng muốn xem bạn sẽ xây dựng được gì. Nếu bạn có câu hỏi hoặc ý tưởng về tính năng, hãy ghé qua [cộng đồng Reddit](https://www.reddit.com/r/RooCode/) hoặc [Discord](https://discord.gg/roocode) của chúng tôi. Chúc bạn viết mã vui vẻ!
