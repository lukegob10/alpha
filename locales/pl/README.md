...
- Dodano Poe jako dostawcę AI, żebyś mógł bezpośrednio uzyskać dostęp do modeli Poe w Alpha.
...
## Co Alpha może zrobić dla CIEBIE?
...
Alpha dostosowuje się do Twojego sposobu pracy, a nie odwrotnie:
...
- **[Dokumentacja](https://docs.roocode.com):** Oficjalny przewodnik po instalacji, konfiguracji i opanowaniu Alpha.
...
- **[Problemy na GitHub](https://github.com/AlphaInc/Alpha/issues):** Zgłaszaj błędy i śledź rozwój.
- **[Prośby o funkcje](https://github.com/AlphaInc/Alpha/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** Masz pomysł? Podziel się nim z deweloperami.
...
Istnieje kilka sposobów na uruchomienie rozszerzenia Alpha:

### Tryb deweloperski (F5)

Do aktywnego programowania użyj wbudowanego debugowania VSCode:

Naciśnij `F5` (lub przejdź do **Uruchom** → **Rozpocznij debugowanie**) w VSCode. Otworzy to nowe okno VSCode z uruchomionym rozszerzeniem Alpha.
...
1.  Najpierw zbuduj pakiet VSIX:
    ...
    pnpm vsix
    ```
2.  Plik `.vsix` zostanie wygenerowany w katalogu `bin/` (np. `bin/alpha-<version>.vsix`).
...
**Miłej zabawy z Alpha!** Trzymaj go na krótkiej smyczy albo pozwól działać autonomicznie — nie możemy się doczekać, co zbudujesz. Masz pytania lub pomysły na funkcje? Wpadnij na naszą [społeczność Reddit](https://www.reddit.com/r/RooCode/) lub [Discord](https://discord.gg/roocode). Miłego kodowania!
