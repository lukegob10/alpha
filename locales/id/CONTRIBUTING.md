...
### 3. Bergabunglah dengan Komunitas Alpha
...
- **Periksa masalah yang ada**: Cari di [Masalah GitHub](https://github.com/RooCodeInc/Alpha/issues).
...
- Untuk dokumentasi, kunjungi [Dokumentasi Alpha](https://github.com/RooCodeInc/Alpha-Docs).

### Melaporkan Bug

- Periksa laporan yang ada terlebih dahulu.
- Buat bug baru menggunakan [template "Laporan Bug"](https://github.com/RooCodeInc/Alpha/issues/new/choose) dengan:
    - Langkah-langkah reproduksi yang jelas dan bernomor
    - Hasil yang diharapkan vs aktual
    - Versi Alpha (wajib); penyedia/model API jika relevan
- **Masalah keamanan**: Laporkan secara pribadi melalui [saran keamanan](https://github.com/RooCodeInc/Alpha/security/advisories/new).
...
```
git clone https://github.com/NAMA_PENGGUNA_ANDA/Alpha.git
```
...
Dengan berkontribusi, Anda setuju bahwa kontribusi Anda akan dilisensikan di bawah Lisensi Apache 2.0, sesuai dengan lisensi Alpha.
