...
- Menambahkan Poe sebagai provider AI agar kamu bisa langsung mengakses model Poe di Alpha.
...
## Apa yang Bisa Alpha Lakukan Untuk ANDA?
...
Alpha beradaptasi dengan cara Anda bekerja, bukan sebaliknya:
...
- **[Dokumentasi](https://docs.roocode.com):** Panduan resmi untuk menginstal, mengonfigurasi, dan menguasai Alpha.
...
- **[Masalah GitHub](https://github.com/AlphaInc/Alpha/issues):** Laporkan bug dan lacak pengembangan.
- **[Permintaan Fitur](https://github.com/AlphaInc/Alpha/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** Punya ide? Bagikan dengan para pengembang.
...
Ada beberapa cara untuk menjalankan ekstensi Alpha:

### Mode Pengembangan (F5)

Untuk pengembangan aktif, gunakan debugging bawaan VSCode:

Tekan `F5` (atau buka **Run** → **Start Debugging**) di VSCode. Ini akan membuka jendela VSCode baru dengan ekstensi Alpha berjalan.
...
1.  Pertama, bangun paket VSIX:
    ...
    pnpm vsix
    ```
2.  File `.vsix` akan dibuat di direktori `bin/` (misalnya, `bin/alpha-<version>.vsix`).
...
**Harap dicatat** bahwa Alpha, Inc. **tidak** membuat pernyataan atau jaminan apapun mengenai kode, model, atau alat lain yang disediakan atau tersedia sehubungan dengan Alpha, alat pihak ketiga terkait, atau output yang dihasilkan. Anda menanggung **semua risiko** yang terkait dengan penggunaan alat atau output tersebut; alat tersebut disediakan atas dasar **"SEBAGAIMANA ADANYA"** dan **"SEBAGAIMANA TERSEDIA"**. Risiko tersebut dapat mencakup, namun tidak terbatas pada, pelanggaran kekayaan intelektual, kerentanan atau serangan siber, bias, ketidakakuratan, kesalahan, cacat, virus, waktu henti, kehilangan atau kerusakan properti, dan/atau cedera pribadi. Anda sepenuhnya bertanggung jawab atas penggunaan Anda atas alat atau output tersebut (termasuk, namun tidak terbatas pada, legalitas, kesesuaian, dan hasilnya).
...
**Selamat menikmati Alpha!** Baik Anda mengendalikannya dengan ketat atau membiarkannya berkeliaran secara otonom, kami tidak sabar untuk melihat apa yang Anda bangun. Jika Anda memiliki pertanyaan atau ide fitur, kunjungi [komunitas Reddit](https://www.reddit.com/r/RooCode/) atau [Discord](https://discord.gg/roocode) kami. Selamat membuat kode!
