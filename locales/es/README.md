...
- Se añadió Poe como proveedor de IA para que puedas acceder directamente a los modelos de Poe en Alpha.
...
Alpha se adapta a tu forma de trabajar, no al revés:
...
- **[Documentación](https://docs.roocode.com):** La guía oficial para instalar, configurar y dominar Alpha.
...
- **[Incidencias de GitHub](https://github.com/AlphaInc/Alpha/issues):** Reporta errores y sigue el desarrollo.
- **[Solicitudes de funcionalidades](https://github.com/AlphaInc/Alpha/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** ¿Tienes una idea? Compártela con los desarrolladores.
...
Hay varias formas de ejecutar la extensión Alpha:

### Modo de desarrollo (F5)

Para el desarrollo activo, utiliza la depuración integrada de VSCode:

Presiona `F5` (o ve a **Ejecutar** → **Iniciar depuración**) en VSCode. Esto abrirá una nueva ventana de VSCode con la extensión Alpha en ejecución.
...
1.  Primero, construye el paquete VSIX:
    ...
    pnpm vsix
    ```
2.  Se generará un archivo `.vsix` en el directorio `bin/` (p. ej., `bin/alpha-<version>.vsix`).
