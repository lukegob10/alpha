...
- Poe को AI provider के रूप में जोड़ा गया है, ताकि आप Alpha में सीधे Poe models तक पहुँच सकें।
...
## Alpha आपके लिए क्या कर सकता है?
...
- **[दस्तावेज़ीकरण](https://docs.roocode.com):** Alpha को स्थापित करने, कॉन्फ़िगर करने और उसमें महारत हासिल करने के लिए आधिकारिक गाइड।
...
- **[गिटहब मुद्दे](https://github.com/AlphaInc/Alpha/issues):** बग की रिपोर्ट करें और विकास को ट्रैक करें।
- **[सुविधा अनुरोध](https://github.com/AlphaInc/Alpha/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** क्या आपके पास कोई विचार है? इसे डेवलपर्स के साथ साझा करें।
...
वीएसकोड में `F5` दबाएं (या **रन** → **डीबगिंग प्रारंभ करें** पर जाएं)। यह Alpha एक्सटेंशन के साथ एक नई वीएसकोड विंडो खोलेगा।
...
1.  पहले, VSIX पैकेज बनाएं:
    ...
    pnpm vsix
    ```
2.  `bin/` डायरेक्टरी में एक `.vsix` फ़ाइल जनरेट होगी (जैसे, `bin/alpha-<version>.vsix` )।
...
**Alpha का आनंद लें!** चाहे आप इसे छोटी लगाम में रखें या इसे स्वायत्त रूप से घूमने दें, हम यह देखने के लिए इंतजार नहीं कर सकते कि आप क्या बनाते हैं। यदि आपके कोई प्रश्न या सुविधा के विचार हैं, तो हमारी [रेडिट समुदाय](https://www.reddit.com/r/RooCode/) या [डिस्कॉर्ड](https://discord.gg/roocode) पर आएं। हैप्पी कोडिंग!
