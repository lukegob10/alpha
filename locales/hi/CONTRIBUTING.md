...
- **मौजूदा समस्याओं की जाँच करें**: [गिटहब समस्याएँ](https://github.com/RooCodeInc/Alpha/issues) में खोजें।
...
- दस्तावेज़ों के लिए, [Alpha दस्तावेज़](https://github.com/RooCodeInc/Alpha-Docs) पर जाएँ।

### बग की रिपोर्ट करना

- पहले मौजूदा रिपोर्ट की जाँच करें।
- ["बग रिपोर्ट" टेम्पलेट](https://github.com/RooCodeInc/Alpha/issues/new/choose) का उपयोग करके एक नया बग बनाएँ:
    - स्पष्ट, क्रमांकित पुनरुत्पादन चरण
    - अपेक्षित बनाम वास्तविक परिणाम
    - Alpha संस्करण (आवश्यक); यदि प्रासंगिक हो तो एपीआई प्रदाता/मॉडल
- **सुरक्षा समस्याएँ**: [सुरक्षा सलाहकारों](https://github.com/RooCodeInc/Alpha/security/advisories/new) के माध्यम से निजी तौर पर रिपोर्ट करें।
...
```
git clone https://github.com/आपका_उपयोगकर्ता_नाम/Alpha.git
```
...
योगदान करके, आप सहमत हैं कि आपके योगदान अपाचे 2.0 लाइसेंस के तहत लाइसेंस प्राप्त होंगे, जो Alpha के लाइसेंस के अनुरूप है।
