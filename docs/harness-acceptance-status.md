...
| `INT-WORKER-GATE-001`       | Actual rendered nested/outer Apply and Discard confirmations passed; canonical proposal and filesystem effects verified.                                                                  | Any factual human checkpoint required by the operator procedure.                                                               |
