...
- `/alpha-translate de` - Focus on German translations
- `/alpha-translate all welcome.title` - Translate a specific key to all languages
- `/alpha-translate zh-CN src/i18n/locales/zh-CN/core.json` - Work on specific file
