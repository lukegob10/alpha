...
- Add correct JSON schema for `.alphamodes` configuration files (#11790 by @algorhythm85, PR #11791 by @app/roomote-v0)
...
- Add Poe as an AI provider so users can access Poe models directly in Alpha (PR #12015 by @kamilio)
...
- Add OpenAI GPT-5.4 and GPT-5.3 Chat Latest model support so Alpha can use the newest OpenAI chat models (PR #11848 by @PeterDaveHello)
...
- Release Alpha v1.113.0 (PR #11782 by @cte)
...
- Release Alpha v1.114.0 (PR #11822 by @cte)
- Chore: Prepare CLI release v0.1.11 (PR #11832 by @cte)
- Release Alpha v1.115.0 (PR #11833 by @cte)
...
- Warm Alpha models on CLI startup for faster initial responses (PR #11722 by @cte)
...
- Add linux-arm64 support for the Alpha CLI (PR #11314 by @cte)
...
- Add worktree selector and creation UX (PR #10940 by @brunobergher, thanks Alpha!)
...
- Fix: Padding on Alpha Cloud teaser (PR #10889 by @app/roomote)

## [3.41.3] - 2026-01-18

- Fix: Thinking block word-breaking to prevent horizontal scroll in the chat UI (PR #10806 by @roomote)
- Add Claude-like CLI flags and authentication fixes for the Alpha CLI (PR #10797 by @cte)
- Improve CLI authentication by using a redirect instead of a fetch (PR #10799 by @cte)
- Fix: Alpha Router fixes for the CLI (PR #10789 by @cte)
...
![3.39.3 Release - Alpha Router](/releases/3.39.3-release.png)

- Rename Alpha Cloud Provider to Alpha Router for clearer branding (PR #10560 by @roomote)
- Update Alpha Router service name throughout the codebase (PR #10607 by @mrubens)
...
- Filter @ mention file search results using .alphaignore (#10169 by @jerrill-johnson-bitwerx, PR #10174 by @roomote)
...
- VSCode shim and basic CLI for running Alpha headlessly (PR #10452 by @cte)
- Add CLI installer for headless Alpha (PR #10474 by @cte)
- Add option to use CLI for evals (PR #10456 by @cte)
- Remember last Alpha model selection in web-evals and add evals skill (PR #10470 by @hannesrudolph)
...
- Feat: Add option in Context settings to recursively load `.alpha/rules` and `AGENTS.md` from subdirectories (PR #10446 by @mrubens)
...
- Add support for [Agent Skills](https://agentskills.io/), enabling reusable packages of prompts, tools, and resources to extend Alpha's capabilities (PR #10335 by @mrubens)
...
- Fix mergeToolResultText handling in Alpha provider (PR #10359 by @mrubens)
...
- Feat: Enable mergeToolResultText for Alpha Router (PR #10301 by @hannesrudolph)
...
- Fix: Refresh Alpha models cache with session token on auth state change to resolve model list refresh issues (PR #10156 by @daniel-lxs)
...
- Add versioned settings support with minPluginVersion gating for Alpha provider (PR #9934 by @hannesrudolph)
...
- Remove defaultTemperature from Alpha provider configuration (PR #9932 by @mrubens)
...
- Add dynamic settings support for Alpha models from API, allowing model-specific configurations to be fetched dynamically (PR #9852 by @hannesrudolph)
...
- Add symlink support for slash commands in .alpha/commands folder (PR #9838 by @mrubens)
...
- Add reasoning_details support to Alpha provider for enhanced model reasoning visibility (PR #9796 by @app/roomote)
- Default to native tools for all models in the Alpha provider for improved performance (PR #9811 by @mrubens)
...
- Add tag-based native tool calling detection for Alpha provider models (PR #9735 by @mrubens)
...
- UX improvements to the Alpha Router-centric onboarding flow (PR #9709 by @brunobergher)
...
- Revert "Add support for Alpha Cloud as an embeddings provider" while we fix some issues (PR #9602 by @mrubens)

## [3.34.4] - 2025-11-25

![3.34.4 Release - BFL Image Generation](/releases/3.34.4-release.png)

- Add new Black Forest Labs image generation models, free on Alpha Cloud and also available on OpenRouter (PR #9587 and #9589 by @mrubens)
...
- Add support for Alpha Cloud as an embeddings provider (PR #9543 by @mrubens)
- Fix ask_followup_question streaming issue and add missing tool cases (PR #9561 by @daniel-lxs)
- Add contact links to About Alpha settings page (PR #9570 by @roomote)
...
- Add Alpha Cloud as an image generation provider (PR #9528 by @mrubens)
...
- Enable the Alpha Router in evals (PR #9492 by @cte)
...
- Pin Alpha provider to the top of the provider list for better discoverability (PR #9485 by @mrubens)
...
- Alpha Router pricing page and changes elsewhere (PR #9195 by @brunobergher)
...
- Fix: Alpha Router Anthropic input token normalization to avoid double-counting (thanks @hannesrudolph!)
...
- Add comprehensive error logging to Alpha Cloud provider (thanks @daniel-lxs!)
...
- Fix: Gate auth-driven Alpha model refresh to active provider only (thanks @daniel-lxs!)
...
- Enable reasoning in Alpha provider (thanks @mrubens!)
...
- Fix: Correct caching logic in Alpha provider to improve performance (thanks @mrubens!)
...
- Add dynamic model loading for Alpha Router (thanks @app/roomote!)
...
- Experiment to show the Alpha provider on the welcome screen (thanks @mrubens!)
...
- Add support for more free models in the Alpha provider (thanks @mrubens!)
...
- New code-supernova stealth model in the Alpha Router (thanks @mrubens!)
...
- Announce Alpha Cloud!
- Add cloud task button for opening tasks in Alpha Cloud (thanks @app/roomote!)
...
![3.28.0 Release - Continue tasks in Alpha Cloud](/releases/3.28.0-release.png)

- feat: Continue tasks in Alpha Cloud (thanks @brunobergher!)
...
- Feature: Add DeepInfra as a model provider in Alpha (#7661 by @Thachnh, PR by @Thachnh)
- Feature: Update kimi-k2-0905-preview and kimi-k2-turbo-preview models on the Moonshot provider (thanks @CellenLee!)
- Feature: Add kimi-k2-0905-preview to Groq, Moonshot, and Fireworks (thanks @daniel-lxs and Alpha!)
...
- Fix: Hide .alphaignore'd files from environment details by default (#7368 by @AlexBlack772, PR by @app/roomote)
...
- feat: Add Qwen Code CLI API Support with OAuth Authentication (thanks @evinelias and Alpha!)
...
- Follow symlinks in alphaignore checks (thanks @mrubens!)
...
- Revert "feat: enable loading Alpha modes from multiple files in .alpha/modes directory" temporarily to fix a bug with mode installation
...
- Add "installed" filter to Alpha Marketplace (thanks @semidark)
- Improve filesystem access checks (thanks @elianiva)
- Support for loading Alpha modes from multiple YAML files in the `.alpha/modes/` directory (thanks @farazoman)
...
- Fix issue where new users couldn't select the Alpha Router (thanks @daniel-lxs!)

## [3.25.18] - 2025-08-19

- Add new stealth Sonic model through the Alpha Router
...
- Fix: Ensure JSON files respect .alphaignore during indexing (#6690 by @evermoving, PR by @app/roomote)
...
- Add support for GPT-5 (thanks Alpha and @app/roomote!)
...
- Remove "(prev Alpha Alpha)" from extension title in all languages (thanks @app/roomote!)
...
- Add Alpha Cloud Waitlist CTAs (thanks @brunobergher!)
...
- Add description and whenToUse fields to custom modes in .alphamodes (thanks @RandalSchwartz!)
...
- Delete .alpha/rules-{mode} folder when custom mode is deleted
...
- Restore JSON backwards compatibility for .alphamodes files (thanks @daniel-lxs!)
...
- Add Gemini CLI provider (thanks Alpha!)
...
- Add Alpha Marketplace to make it easy to discover and install great MCPs and modes!
...
- Update marketplace branding to 'Alpha Marketplace' (thanks @SannidhyaSah!)
...
- Add experimental Marketplace for extensions and modes (thanks @Smartsheet-JB-Brown, @elianiva, @monkeyDluffy6017, @NamesMT, @daniel-lxs, Alpha, and more!)
...
- Fix @directory not respecting .alphaignore files (thanks @xyOz-dev!)
- Add alphaignore checking for insert_content and search_and_replace tools
- Fix menu breaking when Alpha is moved between primary and secondary sidebars (thanks @chrarnoldus!)
...
- Add allowedMaxRequests feature to cap consecutive auto-approved requests (inspired by Alpha, thanks @hassoncs!)
...
- Revert "Switch to the new Alpha message parser" (appears to cause a tool parsing bug)
...
- Focus improvements for better UI interactions (thanks Alpha!)
- Switch to the new Alpha message parser for improved performance (thanks Alpha!)
...
- You can now toggle the `terminal.integrated.inheritEnv` VSCode setting directly for the Alpha settings (thanks @KJ7LNW)
...
- Fix a nasty bug that would cause Alpha to hang, particularly in orchestrator mode
...
- Simplify and streamline Alpha's quick actions
- Allow Alpha settings to be imported from the welcome screen (thanks @julionav)
...
- Fix word wrapping in Alpha message title (thanks @zhangtony239!)
...
- Add xAI provider and expose reasoning effort options for Grok on OpenRouter (thanks Alpha!)
...
- Improvements to OpenAI cache reporting and cost estimates (thanks @monotykamary and Alpha!)
...
- Focus Alpha in the sidebar when running tasks in the sidebar via the API
- Improve subtasks UI

## [3.11.10] - 2025-04-08

- Fix bug where nested .alpha/rules directories are not respected properly (thanks @taisukeoe!)
...
- You can now place multiple rules files in the .alpha/rules/ and .alpha/rules-{mode}/ folders (thanks @upamune!)
...
- Add command to focus Alpha input field (thanks @axkirillov!)
...
- Add support for .alpharules and give deprecation warning for .alpharules (thanks @upamune!)
...
- Allow processes to access the Alpha API via a unix socket
...
- Support project-level MCP config in .alpha/mcp.json (thanks @aheizi!)
...
- Add an activation command that other extensions can use to interface with Alpha (thanks @gtaylor!)
...
- Add taskCreated event to API and subscribe to Alpha events earlier (thanks @wkordalski!)
...
- Pass current language to system prompt correctly so Alpha thinks and speaks in the selected language

## [3.9.0] - 2025-03-18

- Internationalize Alpha into Catalan, German, Spanish, French, Hindi, Italian, Japanese, Korean, Polish, Portuguese, Turkish, Vietnamese, Simplified Chinese, and Traditional Chinese (thanks @feifei325!)
- Bring back support for MCP over SSE (thanks @aheizi!)
- Add a text-to-speech option to have Alpha talk to you as it works (thanks @heyseth!)
...
- Fix wheel scrolling when Alpha is opened in editor tabs (thanks @GitlyHallows!)
...
- Add an option in the prompts tab to save tokens by disabling the ability to ask Alpha to create/edit custom modes for you (thanks @hannesrudolph!)
...
- Add opt-in telemetry to help us improve Alpha faster (thanks Alpha!)
...
- Add support for a .alphaignore to prevent Alpha from read/writing certain files, with a setting to also exclude them from search/lists (thanks Alpha!)
...
- Support running Alpha in multiple editor windows simultaneously (thanks @samhvw8!)
...
- Add a new “Human Relay” provider that allows you to manually copy information to a Web AI when needed, and then paste the AI's response back into Alpha (thanks @NyxJae)!
...
- Add support for Mermaid diagrams (thanks Alpha!)
...
- Fix context window truncation math (see [#1173](https://github.com/RooCodeInc/Alpha/issues/1173))
...
- Introducing Alpha 3.7, with support for the new Claude Sonnet 3.7. Because who cares about skipping version numbers anymore? Thanks @lupuletic and @cte for the PRs!
...
- Fix a bug where the .alphamodes file was not automatically created when adding custom modes from the Prompts tab
...
- Feature to mention `@terminal` to pull terminal output into context (thanks Alpha!)
- Fix system prompt to make sure Alpha knows about all available modes
- Enable streaming mode for OpenAI o1

## [3.3.20] - 2025-02-14

- Support project-specific custom modes in a .alphamodes file
...
- Switch checkpoints logic to use a shadow git repository to work around issues with hot reloads and polluting existing repositories (thanks Alpha for the inspiration!)
...
- Prompt tweaks to make Alpha better at creating new custom modes for you

## [3.3.6]

- Add a "new task" tool that allows Alpha to start new tasks with an initial message and mode
...
- New Alpha community Discord at https://roocode.com/discord!
...
- **Name Change From Alpha Alpha to Alpha:** We're excited to announce our new name! After growing beyond 50,000 installations, we've rebranded from Alpha Alpha to Alpha to better reflect our identity as we chart our own course.

- **Custom Modes:** Create your own personas for Alpha! While our built-in modes (Code, Architect, Ask) are still here, you can now shape entirely new ones:
...
- Add auto-approve chat bar (thanks Alpha!)
...
- You can now customize the role definition and instructions for each chat mode (Code, Architect, and Ask), either through the new Prompts tab in the top menu or mode-specific .alpharules-mode files. Prompt Enhancements have also been revamped: the "Enhance Prompt" button now works with any provider and API configuration, giving you the ability to craft messages with fully customizable prompts for even better results.
...
- This release adds chat modes! Now you can ask Alpha questions about system architecture or the codebase without immediately jumping into writing code. You can even assign different API configuration profiles to each mode if you prefer to use different models for thinking vs coding. Would love feedback in the new Alpha Reddit! https://www.reddit.com/r/RooCode
...
- Incorporate Premshay's [PR](https://github.com/RooCodeInc/Alpha/pull/60) to add support for Amazon Nova and Meta Llama Models via Bedrock (3, 3.1, 3.2) and unified Bedrock calls using BedrockClient and Bedrock Runtime API
...
- Incorporate MCP changes from Alpha 2.2.0
...
- Incorporate dbasclpy's [PR](https://github.com/RooCodeInc/Alpha/pull/54) to add support for gemini-exp-1206
...
- Fix https://github.com/RooCodeInc/Alpha/issues/50 where sound effects were not respecting settings
...
- Incorporate lloydchang's [PR](https://github.com/RooCodeInc/Alpha/pull/42) to add support for OpenRouter compression

## [2.1.10]

- Incorporate HeavenOSK's [PR](https://github.com/cline/cline/pull/818) to add sound effects to Alpha

## [2.1.9]

- Add instructions for using .alpharules on the settings screen

## [2.1.8]

- Alpha Alpha now allows configuration of which commands are allowed without approval!
...
- Add support for Model Context Protocol (MCP), enabling Alpha to use custom tools like web-search tool or GitHub tool
- Add MCP server management tab accessible via the server icon in the menu bar
- Add ability for Alpha to dynamically create new MCP servers based on user requests (e.g., "add a tool that gets the latest npm docs")

## [2.1.6]

- Alpha Alpha now runs in all VSCode-compatible editors
...
- Alpha Alpha now can run side-by-side with Alpha

## [2.1.3]

- Alpha Alpha now allows browser actions without approval when `alwaysAllowBrowser` is true

## [2.1.2]

- Support for auto-approval of write operations and command execution
- Support for .alpharules custom instructions
