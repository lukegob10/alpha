...
import { CodeActionName, CodeActionId } from "@alpha-code/types"
...
export const TITLES: Record<CodeActionName, string> = {
	EXPLAIN: "Explain with Alpha",
	FIX: "Fix with Alpha",
	IMPROVE: "Improve with Alpha",
	ADD_TO_CONTEXT: "Add to Alpha",
	NEW_TASK: "New Alpha Task",
} as const
