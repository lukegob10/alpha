...
import type { OrganizationSettings, MarketplaceItem, MarketplaceItemType, McpMarketplaceItem } from "@alpha-code/types"
...
export class MarketplaceManager {
	...
	private async checkProjectInstallations(metadata: Record<string, { type: string }>): Promise<void> {
		try {
			...
			// Check modes in .alphamodes
			const projectModesPath = path.join(workspaceFolder.uri.fsPath, ".alphamodes")
			try {
