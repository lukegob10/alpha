...
type RuleFiles = {
	".alpharules-code": string
	".alpharules-ask": string
	".alpharules-architect": string
	".alpharules-test": string
	".alpharules-review": string
	".alpharules": string
}
...
const mockFs = {
	readFile: vi.fn().mockImplementation(async (filePath: string, _encoding?: string) => {
		...
		const ruleFiles: RuleFiles = {
			".alpharules-code": "# Code Mode Rules\n1. Code specific rule",
			".alpharules-ask": "# Ask Mode Rules\n1. Ask specific rule",
			".alpharules-architect": "# Architect Mode Rules\n1. Architect specific rule",
			".alpharules-test":
