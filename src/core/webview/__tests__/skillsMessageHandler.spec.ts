...
describe("skillsMessageHandler", () => {
	...
	const createMockProvider = (hasSkillsManager: boolean = true): AlphaProvider => {
	...
	const mockSkills: SkillMetadata[] = [
		...
		},
		{
			...
			path: "/project/.alpha/skills/project-skill/SKILL.md",
			source: "project",
			mode: "code",
		},
	]
	...
	describe("handleOpenSkillFile", () => {
		...
		it("opens a skill file with mode restriction", async () => {
			...
			expect(openFile).toHaveBeenCalledWith("/project/.alpha/skills/project-skill/SKILL.md")
		})
