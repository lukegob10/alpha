...
import { AlphaProtectedController } from "../AlphaProtectedController"

describe("AlphaProtectedController", () => {
	const TEST_CWD = "/test/workspace"
	let controller: AlphaProtectedController

	beforeEach(() => {
		controller = new AlphaProtectedController(TEST_CWD)
	})
	...
	describe("isWriteProtected", () => {
		...
		it("protects existing and new files reached through an alias to a protected directory", () => {
			...
			try {
				...
				const aliasedController = new AlphaProtectedController(tempRoot)
	...
	describe("getProtectedPatterns", () => {
		it("should return the list of protected patterns", () => {
			const patterns = AlphaProtectedController.getProtectedPatterns()
